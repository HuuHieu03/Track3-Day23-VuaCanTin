...
def build_graph(
    ...
    # Register the 11 workflow nodes. Node names are part of the routing contract.
    ...
    # Fixed edges shared by every execution path.
    ...
    # Conditional routing points. Keeping path maps explicit makes invalid node names
    # visible during graph inspection and keeps the graph contract easy to review.
